...
COPY target/johnray-myportfolio-master-0.0.1-SNAPSHOT.jar /app/johnray-myportfolio-master-0.0.1-SNAPSHOT.jar

# Step 4: I-expose ang port na ginagamit ng iyong app (default Spring Boot port: 8080)
EXPOSE 8081

# Step 5: I-run ang Spring Boot app
ENTRYPOINT ["java", "-jar", "/app/johnray-myportfolio-master-0.0.1-SNAPSHOT.jar"]
